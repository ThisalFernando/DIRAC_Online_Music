...
<title>Record is not Inserted!</title>
<style>
	.sTbl {
    width: 970px;
    height: 530px;
...
<table border="0" width="100%" height="200px" class="sTbl">
	<tr>
	<td>
		<img src="<%=request.getContextPath()%>/Images/Image21.png" style="width: 250px; margin-left: 300px;">
	</td>
	</tr>
	<tr>
	<td>
		<h1 align="center">Registration Unsuccessful!</h1><br>
		<a href="SignUp.jsp"><input type="button" id="btnn1" value="Retry" /></a>
	</td>
	</tr>
</table>
</div>
